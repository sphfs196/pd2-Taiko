...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(640, 40, 371, 151));
        QFont font;
        ...
        pushButton_2->setGeometry(QRect(640, 200, 371, 151));
        pushButton_2->setFont(font);
        pushButton_2->setFlat(false);
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(0, 0, 1091, 821));
        label->setPixmap(QPixmap(QString::fromUtf8(":/pics/bear_bg2.jpg")));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(400, 10, 276, 189));
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(420, 170, 240, 240));
